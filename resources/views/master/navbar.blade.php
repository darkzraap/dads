      ...
      <nav class="relative items-center hidden space-x-6 text-sm font-medium md:flex">
        ...
        <div x-data="{ open: false }" class="relative">
          ...
          <div x-show="open" x-transition
               ...
               style="display: none;">
            <a href="#" class="block px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Director</a>
            <a href="#" class="block px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Organization</a>
          </div>
        </div>
        ...
        <div x-data="{ open: false }" class="relative">
          ...
          <div x-show="open" x-transition
               class="absolute left-0 z-50 py-2 mt-2 text-gray-800 bg-white rounded-md shadow-lg w-44"
               style="display: none;">
            <a href="#" class="block px-4 py-2 transition hover:bg-red-100 hover:text-red-600">About</a>
            <a href="#" class="block px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Vision & Mission</a>
            <a href="#" class="block px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Company Competence</a>
            <a href="#" class="block px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Mars Dads</a>
            <a href="#" class="block px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Awards</a>
          </div>
        </div>
      </nav>
  ...
  <div x-show="mobileOpen" x-transition
    ...
    <div class="flex flex-col w-64 h-full p-6 space-y-4 overflow-y-auto text-gray-800 bg-white shadow-lg">
      ...
      <div x-data="{ open: false }">
        <button @click="open = !open" class="flex items-center justify-between w-full py-2 text-left hover:text-red-600">
          Our Team
          <svg xmlns="http://www.w3.org/2000/svg" :class="{ 'rotate-180': open }" class="w-4 h-4 transition-transform transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
      ...
      <div x-data="{ open: false }">
        ...
        <div x-show="open" x-transition class="pl-3 ml-4 space-y-2 border-l border-gray-200">
            <a href="#" class="block text-[12px] px-4 py-2 transition hover:bg-red-100 hover:text-red-600">About</a>
            <a href="#" class="block text-[12px] px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Vision & Mission</a>
            <a href="#" class="block text-[12px] px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Company Competence</a>
            <a href="#" class="block text-[12px] px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Mars Dads</a>
            <a href="#" class="block text-[12px] px-4 py-2 transition hover:bg-red-100 hover:text-red-600">Awards</a>
        </div>
      </div>
    </div>
  </div>
