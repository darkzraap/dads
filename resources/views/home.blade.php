...
@include('master.navbar')
  ...
  <section
    class="relative flex items-center justify-center w-full h-screen pt-24 bg-center bg-cover"
    ...
    <div class="relative px-6 text-center text-white">
      ...
      <button class="px-6 py-2 text-red-400 transition border border-red-500 rounded-md hover:bg-red-500 hover:text-white animate-fadeUp">
        Explore
      </button>
...
<section class="relative w-full h-[480px] md:h-[560px] overflow-hidden">
  ...
  <div class="relative z-10 flex flex-col items-start justify-center h-full px-8 text-white md:px-16">
    ...
    <a href="#projects" class="font-semibold text-red-400 transition hover:text-red-500">
      See more projects →
    </a>

    <!-- Arrows -->
    <div class="absolute flex gap-3 right-8 bottom-10">
      <button class="flex items-center justify-center w-10 h-10 transition border rounded-full bg-white/10 border-white/30 hover:bg-white/20">
...
<section class="py-16 bg-white">
  <div class="max-w-6xl px-6 mx-auto">
    ...
    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
      <!-- Card -->
      <div class="overflow-hidden transition-transform duration-300 bg-white shadow-lg rounded-xl hover:-translate-y-2">
    ...
    <div class="mt-10 text-center">
      <a href="#" class="px-6 py-2 font-medium text-white transition bg-blue-700 rounded-full hover:bg-blue-800">
        See More
      </a>
    </div>
  </div>
